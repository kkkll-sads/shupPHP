...
$server = isset($_REQUEST['server']) || isset($_SERVER['HTTP_SERVER']) || substr($_SERVER['REQUEST_URI'], 1, 9) == 'index.php' || $_SERVER['REQUEST_METHOD'] == 'OPTIONS' || strpos($_SERVER['REQUEST_URI'], '/api/') === 0;
if (!$server) {
    /*
     * 用户访问前端
