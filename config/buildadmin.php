...
return [
    // 允许跨域访问的域名
    'cors_request_domain'   => 'localhost,127.0.0.1,http://localhost:1818,http://192.168.0.156:3000/#/admin/login',
    // 是否开启会员登录验证码
    'user_login_captcha'    => true,
    // 是否开启管理员登录验证码
    'admin_login_captcha'   => true,
    // 会员登录失败可重试次数,false则无限
    'user_login_retry'      => false,
    ...
    'token'                 => [
        ...
        'default' => 'mysql',
        // 加密key
        'key'     => 'qn5DPFAdB3aZY7eTVfGtQ0mRNSUhsrvz',
        // 加密方式
        'algo'    => 'ripemd160',
        // 驱动
        'stores'  => [
