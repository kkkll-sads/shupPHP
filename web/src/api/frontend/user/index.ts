...
export function getAssetLog(type: string, page: number, pageSize: number) {
    return createAxios({
        url: accountUrl + 'assetLog',
        method: 'GET',
        params: {
            type: type,
            page: page,
...
export function getSignInRecords(page: number, pageSize: number) {
    return createAxios({
        url: signInUrl + 'records',
        method: 'POST',
        data: {
            page: page,
            page_size: pageSize,
