...
const actionTypeMap = {
    ...
    cancel_mining_admin: '后台取消挖矿',
    collection_mining: '藏品挖矿',
    consignment_cleared: '寄售清算',
    consignment_coupon_issued: '寄售券发放',
    consignment_coupon_sync: '寄售券同步',
    consignment_coupon_use: '寄售券使用',
    consignment_offshelf: '寄售下架',
    consignment_profit_score: '寄售积分收益',
    daily_dividend: '每日分红',
    finance_cancel: '理财赎回',
    finance_compound: '理财复利',
    finance_gift: '理财赠送',
    finance_income_daily: '理财每日收益',
    finance_income_period: '理财周期收益',
    finance_income_stage: '理财阶段收益',
    manual_mining: '手动挖矿',
    manual_mining_admin: '后台手动挖矿',
    matching_failed: '撮合失败',
    matching_seller_income: '卖家撮合收入',
    mining_dividend: '挖矿分红',
