                ...
                <el-form-item label="配置说明">
                    <el-alert type="info" :closable="false" show-icon>
                        <template #default>
                            ...
                            <div class="alert-tip">&nbsp;&nbsp;&nbsp;&nbsp;• <strong>分红价格比例</strong>：按藏品当前价格的比例分红（如0.01表示1%，价格374元分红3.74元）</div>
                            <div class="alert-tip">&nbsp;&nbsp;&nbsp;&nbsp;• <strong>固定分红金额</strong>：当价格比例为0时，使用固定金额分红（如每日10元）</div>
                ...
                <el-row :gutter="20">
                    <el-col :xs="24" :sm="12">
                        <el-form-item label="分红价格比例">
                            ...
                            <span class="form-tip">按藏品当前价格的比例分红（如0.01表示1%），设置为0则使用固定金额分红</span>
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12">
                        <el-form-item label="固定分红金额">
                            ...
                            <span class="form-tip">元（当价格比例为0时使用的固定分红金额）</span>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-divider />
