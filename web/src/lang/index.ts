...
export async function loadLang(app: App) {
    ...
    if (locale == 'zh-cn') {
        ...
        window.loadLangHandle = {
            ...import.meta.glob('./backend/zh/**/*.ts'),
            ...import.meta.glob('./frontend/zh/**/*.ts'),
            ...import.meta.glob('./backend/zh.ts'),
            ...import.meta.glob('./frontend/zh.ts'),
        }
    } else {
    ...
    if (locale == 'zh-cn') {
        ...
        assignLocale[locale].push(getLangFileMessage(import.meta.glob('./common/zh/**/*.ts', { eager: true }), locale))
    } else if (locale == 'en') {
