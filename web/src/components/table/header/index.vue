<template>
    ...
    <div v-bind="$attrs" class="table-header ba-scroll-style">
        ...
        <el-tooltip v-if="props.buttons.includes('export')" :content="t('Export')" placement="top">
            <el-button v-blur @click="onAction('export')" class="table-header-operate" color="#67c23a" type="success">
