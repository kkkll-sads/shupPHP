...
class Auth extends \ba\Auth
{
     ...
     * @var array
     */
    protected array $allowFields = ['id', 'username', 'nickname', 'email', 'mobile', 'avatar', 'gender', 'birthday', 'money', 'balance_available', 'service_fee_balance', 'withdrawable_money', 'usdt', 'static_income', 'dynamic_income', 'score', 'green_power', 'draw_count', 'join_time', 'motto', 'last_login_time', 'last_login_ip', 'user_type', 'old_assets_status', 'service_fee_balance', 'pending_activation_gold', 'consignment_coupon'];
    ...
    {
        // 昵称前缀
        $prefixes = ['用户', '小', '快乐的', '聪明的', '勤劳的', '好运的', '阳光的', '温暖的'];
        // 昵称后缀
        $suffixes = ['豆子', '朋友', '宝宝', '天使', '精灵', '侠士', '飞侠', '勇者', '高手', '大侠', '小子', '老兄', '哥们', '兄弟', '伙伴'];
        
        $prefix = $prefixes[array_rand($prefixes)];
        $suffix = $suffixes[array_rand($suffixes)];
        $random = Random::build('alnum', 4);
