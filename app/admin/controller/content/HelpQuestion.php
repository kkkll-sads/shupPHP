...
use app\admin\model\HelpQuestion as HelpQuestionModel;

class HelpQuestion extends Backend
{
    /**
     * @var HelpQuestionModel
     */
    ...
    {
        parent::initialize();
        // 使用富文本专用的 XSS 清理，仅清除恶意脚本，保留正常的 HTML 标签
        $this->request->filter('clean_xss');
        $this->model = new HelpQuestionModel();
    }
