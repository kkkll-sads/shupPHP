...
use app\admin\model\FinanceProduct as FinanceProductModel;

class Product extends Backend
{
    /**
     * @var FinanceProductModel
     */
    protected object $model;

    protected string|array $quickSearchField = ['name', 'slug', 'id'];

    public function initialize(): void
    {
        parent::initialize();
        $this->model = new FinanceProductModel();
    }
