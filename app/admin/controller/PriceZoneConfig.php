...
use app\admin\model\PriceZoneConfig as PriceZoneConfigModel;

class PriceZoneConfig extends Backend
{
    /**
     * @var PriceZoneConfigModel
     */
    ...
    {
        parent::initialize();
        $this->model = new PriceZoneConfigModel();
    }
